...
% Grid.V: A column vector of length Nx that contains the cell volumes.
Grid.dy=1;
Grid.dz=1;
Grid.V =Grid.dx*Grid.dz*Grid.dy*sparse(ones(Grid.Nx,1));
% Grid.A: A column vector of length Nfx that contains all face areas.
Grid.A=Grid.dz*Grid.dy*sparse(ones(Grid.Nfx,1));
% For the moment assume that dy and dz = 1.
